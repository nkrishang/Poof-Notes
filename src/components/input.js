        ...
        <div className="Note m-4">
            ...
            <div className="h-auto rounded-md shadow-lg bg-white" style={{width: "500px"}}>
                ...
                <Collapse in={collapseState} timeout='auto'>
                    <div>
                        <textarea value={noteText} onChange={handleNoteText} style={{resize: "none", width: "450px"}} rows="7" className="mx-6 my-2 p-4 font-mono" maxLength="255" placeholder={collapseState ? 'Take a note...' : ''}>
                        </textarea>
